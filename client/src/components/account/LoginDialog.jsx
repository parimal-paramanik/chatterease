...
const LoginDialog = () => {
    ...
    return (
        ...
        >
            <Component>
                <Container>
                    <Title>To use Chatter-ease on your computer:</Title>
                    <StyledList>
                        <ListItem>1. Open Chatter-ease on your phone</ListItem>
                        <ListItem>2. Tap Menu Settings and select Chatter-ease Web</ListItem>
